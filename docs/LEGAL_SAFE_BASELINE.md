...
Objetivo: atingir paridade funcional com referencia externa.

## Regras obrigatorias

- copiar/colar arquivos, funcoes, classes, comentarios ou textos do projeto de referencia.
- Nao reutilizar nomes internos exclusivos quando eles nao forem necessarios.
- Descrever comportamento esperado (entrada, saida, estado, erro, performance).
...
## O que  pode ser copiado literalmente
